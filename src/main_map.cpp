...
/*   Updated: 2022/12/16 17:01:27 by raweber          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) {
	...
	std::cout << "Max size is: " << m1.max_size() << std::endl << std::endl;
	usleep(delay);
	...
	std::cout << "Current size is: " << m1.size() << std::endl;
	print_values(m1);
	std::cout << COLOR_BLUE << "Erase the element with the key *9* via calling 'm1.erase(\"9\")'" << COLOR_DEFAULT << std::endl;
	m1.erase("9");
	std::cout << "Current size is: " << m1.size() << std::endl;
	print_values(m1);
	...
	std::cout << "Function returns pair of iterators pointing to: " << COLOR_GREEN << ret.first->second << " and " << ret.second->second << COLOR_DEFAULT << std::endl;
	std::cout << COLOR_BLUE << "Find lower_bound with the key *4* via 'm1.lower_bound(\"4\")'" << COLOR_DEFAULT << std::endl;
	std::cout << "Function returns iterator pointing to: " << COLOR_GREEN << (m1.lower_bound("4"))->second << COLOR_DEFAULT << std::endl;
	std::cout << COLOR_BLUE << "Find lower_bound with the key *444* via 'm1.lower_bound(\"444\")'" << COLOR_DEFAULT << std::endl;
	std::cout << "Function returns iterator pointing to: " << COLOR_GREEN << (m1.lower_bound("444"))->second << COLOR_DEFAULT << std::endl;
	std::cout << COLOR_BLUE << "Find upper_bound with the key *4* via 'm1.upper_bound(\"4\")' " << COLOR_DEFAULT << std::endl;
	std::cout << "Function returns iterator pointing to: " << COLOR_GREEN << (m1.upper_bound("4"))->second << COLOR_DEFAULT << std::endl;
	std::cout << COLOR_BLUE << "Find upper_bound with the key *444* via 'm1.upper_bound(\"444\")' " << COLOR_DEFAULT << std::endl;
	std::cout << "Function returns iterator pointing to: " << COLOR_GREEN << (m1.upper_bound("444"))->second << COLOR_DEFAULT << std::endl;
	...
	std::cout << "Function returns: " << COLOR_GREEN << m1.key_comp()(m1.begin()->first, (++m1.begin())->first) << COLOR_DEFAULT << std::endl;
	...
	std::cout << "Function returns: " << COLOR_GREEN << m1.value_comp()(*(m1.begin()), (*(++m1.begin()))) << COLOR_DEFAULT << std::endl << std::endl;
	usleep(delay);
